...
const productionApiUrl = (isBrowser && (window as any).__API_URL__) || 'https://quizmaster-api.onrender.com/api';
const productionHubUrl = (isBrowser && (window as any).__HUB_URL__) || 'https://quizmaster-api.onrender.com/hubs/quiz';
